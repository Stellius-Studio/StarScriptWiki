## Description
Reads a Redis-backed variable and exposes it as a skill variable, so later `Skills:` lines in the
...
ReadRedScore:
  Skills:
  - getredis{var=score_red;default=0} @trigger
...
ReadPartyQuestProgress:
  Skills:
  - getredis{var=quest_progress;default=0;scope=custom;group=<skill.var.party_id>} @trigger
...
- [getsql](Skills-Mechanics-getsql) / [getmongo](Skills-Mechanics-getmongo) — same shape, SQL/MongoDB-backed.
